...
# 服务器返回的错误信息
error = ""
students=[['孙世明','1120190304']]
webhook="https://oapi.dingtalk.com/robot/send?access_token=79e6f2ea83a3b28f4444178691f1a05b2f523f6f6380ba20aad1d3d940237670"
try:
    # 登录
    # url = 'https://www.informationofdum.com/DMU_WEB/init/student/'
    # login = {
    #     'uuid_name': '孙世明',
    #     'uuid_number': '1120190304',
    #     'uuid_yqm': '1234'
    # }
    # headers = {}
    # requests.packages.urllib3.disable_warnings()
    # result = requests.post(url, data=login, headers=headers, verify=False)
    # print('登录状态：', result)

    url = 'https://www.informationofdum.com/DMU_WEB/student_5/info/'
    fillinData = {
        'jsonnumber': '1120190304',
        'jsonname': "孙世明",
